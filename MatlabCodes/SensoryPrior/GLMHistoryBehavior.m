...
for Mouse=61:67;
    ...
    save(strcat('C:\Users\Sadegh\Documents\VLMReborn\MatlabCodes\SensoryPrior\2018_11_14_BehaviorPriors\Mouse',num2str(Mouse-60)), ...
...
figure()
for Mouse=61:67
    load(strcat('C:\Users\Sadegh\Documents\VLMReborn\MatlabCodes\SensoryPrior\2018_11_14_BehaviorPriors\Mouse',num2str(Mouse-60),'.mat'))
    for HL=1:HLength
...
for M=1:7
    ...
    plot(HPriorMtx{HL,1,M}(2+HL:1+(2*HL)),'k--')
    
    plot(HPriorMtx{HL,2,M}(2:1+HL),'b')
    plot(HPriorMtx{HL,2,M}(2+HL:1+(2*HL)),'b--')
