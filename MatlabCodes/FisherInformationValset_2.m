...
%     [PLSRotation,YL] = plsregress(DataSet',group,5); 
...
% 
% save('C:\Users\Sadegh\Documents\VLMReborn\Reports\2016_3_3_FisherInformationTI\DuringReward\HitCR\L354_8_8_2015_active_tr',...
%   'IFisher','Signal','Noise','errorVal','ErrorCurve','BMAT','InterceptMAT','FAonFA','FAonCR','MissonMiss','MissonHit','HitSE','MissSE','CRSE','FASE');
% 
