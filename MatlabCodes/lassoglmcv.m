function [B,intercept,ErrCurve,ErrVar,Lambda]=lassoglmcv(Set,group,trialNumber,crossVal,Repeat,doShuff)
% Set=DataSet;
...
for rep=1:Nr
    ...
    for iii=1:crossVal
        ...
        [B,FitInfo]=lassoglm(TrainSet,TrainClass,'binomial','Lambda',ILambda,'RelTol',0.001);
