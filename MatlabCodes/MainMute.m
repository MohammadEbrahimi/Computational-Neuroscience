...
%%  Defining the strings to load the data files
   ...
   nameDataDir  = 'L354/';
    ...
    dataDir      = ['C:/Users/Sadegh/Documents/VLMReborn/Reports/2016_14_11_TransferEntropy/DuringStim/HitCR_inst/' nameDataDir]; % Adjust according to your path -> just as example: dataDir = ['/home/alessandro/Scrivania/MuTE/' nameMainDir];
...
%     % **************************************************
    ...
    mutePath = ('C:/Users/Sadegh/Documents/MATLAB/MuTE_guiUpdate/'); % Adjust according to your path -> just an example: mutePath = '/home/alessandro/Scrivania/MuTE/';
    cd(mutePath);
    addpath(genpath(pwd));
...
%%    defining result directories 
    ...
    nnMexa64Path = 'C:/Users/Sadegh/Documents/MATLAB/MuTE_guiUpdate/OpenTSTOOL/tstoolbox/mex/mexa64/'; % Adjust according to your path -> just an example nnMexa64Path = '/home/alessandro/Scrivania/MuTE/OpenTSTOOL/tstoolbox/mex/mexa64/';
    % *****************************************************
...
%%  Defining the experiment parameters
    ...
    autoPairwiseTarDriv  = [0 1 0 1 0 0 0 0];
...
%  
    ...
    [output1,params1]               = parametersAndMethods(listRealization,samplingRate,pointsToDiscard,channels,autoPairwiseTarDriv,...
                                      ...
                                      'linnue',[],[],[],5,'multiv',@evaluateLinearNonUniformEntropy,[1 1],100,0.01,@generateConditionalTerm,0,...
                                      'binue',[],[],[],5,'multiv',8,@conditionalEntropy,@quantization,[1 0],[1 1],100,0.01,20,...
                                      @generateConditionalTerm,0,...
                                      'binnue',[],[],[],5,'multiv',8,@evaluateNonUniformEntropy,@quantization,[1 1],100,0.01,@generateConditionalTerm,0,0,...
                                      ...
                                      'nnue',[],[],[],5,'multiv',[1 1],100,'maximum',10,nnMexa64Path,mutePath,0.01,10,@generateConditionalTerm,0,...
                                      'nnnue',[],[],[],5,'multiv',[1 1],100,'maximum',10,@nearNeiConditionalMutualInformation,...
                                      @evalNearNeiTestSurrogates2rand,nnMexa64Path,mutePath,0.01,@generateConditionalTerm,0);
    close all
    toc
