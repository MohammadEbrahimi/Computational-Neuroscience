%%%%%%%%%%%%%%%Normalization
for i=1:cellCount
    cellData(i,1:11998)=cellData(i,1:11998)/sqrt(var(cellData(i,1:11998)));
    cellData(i,11999:23996)=cellData(i,11999:23996)/sqrt(var(cellData(i,11999:23996)));
    cellData(i,23997:end)=cellData(i,23997:end)/sqrt(var(cellData(i,23997:end)));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     %%%%Active sesseions L347
%         SE0=CRSE(2:81,:);
%         SE1=HitSE(2:123,:);
    %%%%Active sesseions L354
        SE0=CRSE(2:end,:);
        SE1=HitSE(2:end,:);
...
% save('C:\Users\Sadegh\Documents\VLMReborn\Reports\2016_3_3_FisherInformationTI\DuringReward\HitCR\L347_8_5_2015_active_tr',...
